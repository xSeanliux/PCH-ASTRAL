...
This work is a collaborative effort by members of the [Computational Phylogenetics in Historical Linguistics](https://tandy.cs.illinois.edu/histling.html) (CPHL) group -- Tandy Warnow, Steven Evans, Donald Ringe, Marc Canby, and myself. This repository contains the code, data, and visualization tools that were used to generate the results and figures in the paper *Estimating Language Phylogenies from Polymorphic Characters* (in preparation).
